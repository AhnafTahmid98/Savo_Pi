...
"""Resume a verified saved map into a new mapping session."""
...
def _perform(context, name: str) -> str:
    """Resolve a named launch configuration."""
    return LaunchConfiguration(name).perform(context)


def _parse_bool(value: str) -> bool:
    """Parse a launch boolean value."""
...
def _setup_continued_mapping(context):
    """Validate resume inputs and construct continued-mapping actions."""
    source_root = Path(
        os.path.expanduser(
    ...
    def _after_verification(event, _context):
        """Start mapping only after saved-map verification succeeds."""
    ...
    def _cleanup(_context):
        """Remove the generated temporary parameter file."""
        try:
...
def generate_launch_description():
    """Create the continued-mapping launch description."""
