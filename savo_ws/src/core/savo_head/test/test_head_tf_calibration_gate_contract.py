...
def test_head_tf_config_is_node_specific_and_disabled_until_measured() -> None:
    ...
    assert params["pan_to_tilt_xyz_m"] == [0.0, 0.0, 0.0]
    assert params["tilt_to_camera_xyz_m"] == [0.0, 0.0, 0.0]
