...
struct RosCommandDispatcherSnapshot
{
  ...
  std::string mapping_map_id{};
  std::uint32_t mapping_map_revision{0U};
  std::string mapping_state{};
  std::string mapping_reason{};
  bool mapping_active{false};
  bool mapping_ready{false};
  bool mapping_safety_stop_active{false};
  std::uint32_t mapping_goals_succeeded{0U};
  std::uint32_t mapping_goals_failed{0U};
  std::uint32_t mapping_detected_frontiers{0U};
  std::uint32_t mapping_reachable_frontiers{0U};
  double mapping_coverage_completion_ratio{0.0};
  std::string mapping_scan360_stage{};
  std::string mapping_scan360_state{};
  std::string mapping_scan360_reason{};
  bool mapping_map_save_complete{false};
  bool mapping_map_saved{false};
  std::string mapping_map_save_reason{};
  bool mapping_verification_complete{false};
  bool mapping_map_verified{false};
  std::string mapping_verification_reason{};
  bool mapping_location_verification_complete{false};
  bool mapping_location_verification_passed{false};
  std::uint32_t mapping_pending_candidate_count{0U};
  std::uint32_t mapping_approved_location_count{0U};
  std::uint64_t mapping_review_generation{0U};
  bool mapping_approval_pending{false};
  bool mapping_approval_recorded{false};
  bool mapping_release_complete{false};
  bool mapping_release_succeeded{false};
  std::string mapping_release_id{};
  std::string mapping_release_state{};
  std::string mapping_release_reason{};
  bool mapping_joint_active_release_verified{false};
