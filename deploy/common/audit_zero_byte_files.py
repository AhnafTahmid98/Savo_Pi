...
REQUIRED_DOCS = {
    ...
    "docs/setup/commissioning_checklist.md",
    "docs/setup/development_environment.md",
    "docs/setup/device_permissions_and_udev.md",
    "docs/setup/environment_and_secrets.md",
    "docs/setup/first_installation_checklist.md",
    "docs/setup/network_and_time_setup.md",
    "docs/setup/observer_pc_setup.md",
    "docs/setup/realsense_setup.md",
    "docs/setup/ros_domain_networking.md",
    "docs/setup/savo_core_setup.md",
    "docs/setup/savo_edge_setup.md",
    "docs/setup/savomind_edge_setup.md",
